INSERT INTO patterns (ID,type, name, pattern, sample)
	...
	(3,'MovieFileName', 'TamilRockerss', 'www.TamilRockerss.[a-z]{2,4} - (?<title>[a-zA-Z0-9. ()-]*) \((?<year>[0-9]{4})\) *[a-zA-Z .\[\]0-9\-]*.[a-z0-9]{2,4}','www.TamilRockerrs.co - Lonappante Mamodisa (2019) [Malayalam Original - DVDRip - x264 - 850MB].mkv'),
